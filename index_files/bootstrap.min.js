...
function GetPageItems() {
  ...
  responce={data:{
    "sliders": [
        {
            "title": null,
            "subTitle": null,
            "imageUrl": "/assets/img/login/def3.webp",
            "width": 1025,
            "height": 400,
            "href": null
        }
    ...
    "notifications": [
        {
            "title": "سازمانی",
            "shortText": "2- در صورت هرگونه سوال یا خطا میتوانید قسمت <a class='text-info' href='/help'>راهنما و سوالات متداول</a> رامشاهده نمایید.",
            "longText": "2- در صورت هرگونه سوال یا خطا میتوانید قسمت <a class='text-info' href='/help'>راهنما و سوالات متداول</a> رامشاهده نمایید.",
        ...
        {
            "title": "سازمانی",
            "shortText": "2- به جهت رعایت حال همکاران متقاضی انتقال برون استانی، بازه ثبت نام متقاضیان یک هفته تمدید می گردد.",
            "longText": "1- به جهت رعایت حال همکاران متقاضی انتقال برون استانی، بازه ثبت نام متقاضیان یک هفته تمدید می گردد.",
            ...
            "creator": "فناوری",
            "deleted": false,
            "pStartDate": "1403/04/04 00:00:00",
            "pEndDate": "1403/04/12 00:00:00"
        },
        {
            "title": "عمومی",
            "shortText": "1- والدین از طریق دکمه «ورود والدین/عموم/فرهنگیان» باید وارد شده و رمز عبور فرزند خود را تعیین کنند.\r\n",
            "longText": "1- والدین از طریق دکمه «ورود والدین/عموم/فرهنگیان» باید وارد شده و رمز عبور فرزند خود را تعیین کنند.\r\n",
        ...
        {
            "title": "عمومی",
            "shortText": "3- در صورت هرگونه سوال یا خطا میتوانید قسمت <a class='text-info' href='/help'>راهنما و سوالات متداول</a> رامشاهده نمایید.",
            "longText": "3- در صورت هرگونه سوال یا خطا میتوانید قسمت <a class='text-info' href='/help'>راهنما و سوالات متداول</a> رامشاهده نمایید.",
    ...
    "events": [
      ...
      "title": "پیش ثبت نام هفتم نمونه دولتی",
      "startDate": "2024-06-26T00:00:00",
      "endDate": "2024-07-01T00:00:00",
      "pStartDate": "1403/04/06",
      "pEndtDate": "1403/04/11",
      ...
      responce.data.sliders.forEach(element => {
        if (temp == '')
          temp += '<div class="carousel-item active " style="min-height: 500px;scale: 1;height: 500px;display: flex;"><img class="d-block" loading="lazy" src="' + element.imageUrl + '" alt="my medu" style="max-width: 100%;margin: auto;max-height:100%"></div>'
        else
          temp += '<div class="carousel-item " style="min-height: 500px;scale: 1;height: 500px;display: flex;"><img class="d-block" loading="lazy" src="' + element.imageUrl + '" alt="my medu" style="max-width: 100%;margin: auto;max-height:100%"></div>'
      });
